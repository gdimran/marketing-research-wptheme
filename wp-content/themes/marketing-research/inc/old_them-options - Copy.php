 ...
 'fields' =>array(
	...
	array(
		'id' => 'testimonials_iteams',
         'type' => 'slider',
         'title' =>__( 'Testimonial Iteam', 'redux-framework-demo' ),
		 'subtitle' =>  __('Add testimonials', 'redux-framework-demo' ),
		 'desc' =>	__('You can add unlimited numbers of testimonials item here. You can drag and drop here too.' , 'redux-framework-demo' ),
		 'placeholder'=>array(
				'desc'		=>__('Testimonials Description','redux-framework-demo'),
				'title'		=>__('Woner Title','redux-framework-demo'),
		 ),
	),
)
)
